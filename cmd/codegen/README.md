...
Flags:
    ...
    -p, --preset                 Preset of custom (manual) generator rules. See go doc github.com/elokore/cimgui-go-vulkan/cmd/codegen.Preset for more details. (in form of json file)    (type: string)
...
type Preset struct {
	...
	// Example:
	//   "github.com/elokore/cimgui-go-vulkan"
	//   If enerated with -pkg imgui, import path
	//   is supposed to be "github.com/elokore/cimgui-go-vulkan/imgui"
	PackagePath string
	...
	// github.com/elokore/cimgui-go-vulkan/internal.WrappableType[CTYPE, SELF]
