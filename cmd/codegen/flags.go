...
type flags struct {
	...
	PresetJsonPath string `names:"-p, --preset" usage:"Preset of custom (manual) generator rules. See go doc github.com/elokore/cimgui-go-vulkan/cmd/codegen.Preset for more details. (in form of json file)"`
